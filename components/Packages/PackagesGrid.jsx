            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <div className="mt-auto flex flex-col gap-3 pt-3 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="flex max-w-lg gap-2 rounded">
                    {/* View Details Button */}
                    <Link
                      href={pkg?.url || "#"}
                      className="text-primary border-primary/70 flex items-center justify-center gap-1 rounded-l-lg border bg-white px-4 py-3 text-sm font-normal transition-all duration-300 ease-in-out hover:-translate-y-[2px] hover:shadow-md"
                    >
                      View Details
                      <ChevronRight
                        size={16}
                    ...
                    {/* Get Quote Button */}
                    <button className="bg-primary-gradient flex items-center justify-center gap-2 rounded-r-lg px-4 py-3 text-sm font-normal text-white shadow-md transition-all duration-300 ease-in-out hover:-translate-y-[2px] hover:shadow-lg hover:brightness-110">
                      Get Quote
                      <ChevronRight
                        size={16}
                        className="transition-transform duration-300 group-hover:translate-x-1"
